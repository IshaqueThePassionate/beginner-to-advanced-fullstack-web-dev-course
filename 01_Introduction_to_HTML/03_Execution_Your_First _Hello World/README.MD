...
![Go live img](./images/vs-code-go-live.png)

* Your default browser will automatically open and show your "Hello World" message.

![displaying hellow world img](./images/hello-world-html.png)
